        ...
        <v-card>
          ...
          <v-card-text>
            <v-layout
              ...
              style="max-height: calc(105vh - 70px - 59px - 87px)"
            >
              <v-flex
                :class="{'md4':!showOrderHistory,'md3':showOrderHistory}"
                sm12
                xs12
              >
                <v-layout class="my-0">
                  <v-flex
                    :class="{'md6':!showOrderHistory,'md12':showOrderHistory}"
                    sm12
                    xs12
                  >
                    <!-- customer -->
                  ...
                  <v-flex v-show="!showOrderHistory" md6 sm12 xs12>
                    <v-text-field
                      v-if="model.customer"
                ...
                <v-layout v-if="model.customer" v-show="!showOrderHistory">
                  <v-flex md6 sm12 xs12>
                    <!-- city -->
                    <v-text-field
                      v-model="model.customer.city.name"
                      readonly
                      disabled
                      hide-details
                      label="City"
                  ...
                  <v-flex md6 sm12 xs12>
                    <!-- zone -->
                    <v-text-field
                      v-model="model.customer.zone.name"
                      readonly
                      disabled
                      label="Zone"
                      hide-details
                ...
                <v-layout v-if="model.billing_address">
                  ...
                  >
                    ...
                    <validation-provider
                      v-slot="{ errors }"
                      name="City"
                      :rules="{required:model.billing_address.zone}"
                    >
                      <v-autocomplete
                  ...
                  >
                    ...
                    <validation-provider
                      v-slot="{ errors }"
                      name="Zone"
                      :rules="{required:model.billing_address.city}"
                    >
                      <v-autocomplete
                ...
                >
                  <v-textarea
                    v-if="model.customer"
                    v-model="model.billing_address.address"
                    label="Address"
                    rows="2"
                    flat
                    required
              ...
              />
              <v-flex
                :class="{'md8':!showOrderHistory,'md6':showOrderHistory}"
                sm12
                xs12
              >
                <v-data-table
                ...
                >
                  ...
                  <template #[`item.actions`]="{ item }">
                    <div v-if="item.id===selectedItem.id">
                      ...
                      <v-icon color="green" @click="saveItem">
                        mdi-content-save
                      </v-icon>
                    </div>
                    <div v-else>
                ...
                <v-divider />
                <!-- qty -->
                <!-- <v-flex md6 sm12 xs12 offset-md-6>
              <v-simple-table :class="{'mr-14':$vuetify.breakpoint.mdAndUp}">
                <template #default>
                  <tbody>
...
export default {
  ...
  computed: {
    ...
    leftFlex () {
      return this.showOrderHistory ? 'md2' : 'md4'
    },
    totalQty () {
