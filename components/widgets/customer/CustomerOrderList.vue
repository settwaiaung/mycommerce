...
export default {
  ...
  data () {
    return {
      ...
      // },
      options: { page: 1, itemsPerPage: 5, sortBy: [], sortDesc: [false], groupBy: [], groupDesc: [], mustSort: false, multiSort: false, totalcustomerOrders: 0 },
      loadingData: false
    }
  },
  computed: {
  ...
  watch: {
    options: {
      handler (newVal, oldVal) {
        ...
        console.log('Wrok')
        // this.paginationDataTable(this, this.$url.ORDER_URL)
        // setTimeout(() => {
